    ...
    public class ZclClusterType
    {
        ...
        static ZclClusterType()
        {
            _idValueMap = new Dictionary<ushort, ZclClusterType>
            {
                ...
                { 0x0011, new ZclClusterType(0x0011, "Binary Value (Basic)", ClusterType.BINARY_VALUE_BASIC, (endpoint) => new ZclBinaryValueBasicCluster(endpoint)) },
