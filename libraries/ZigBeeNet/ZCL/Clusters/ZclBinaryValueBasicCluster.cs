...
namespace ZigBeeNet.ZCL.Clusters
{
    ...
    public class ZclBinaryValueBasicCluster : ZclCluster
    {
        ...
        /// <summary>
        /// The MinimumOffTime attribute,  of type 32-bit Unsigned integer, represents the minimum number of
        ...
        /// </summary>
        public const ushort ATTR_MINIMUMOFFTIME = 0x0042;

        /// <summary>
        /// The MinimumOnTime attribute, of type 32-bit Unsigned integer, represents the minimum number of
        /// seconds that a binary PresentValue shall remain in the ACTIVE(1) state after a
        /// write to PresentValue causes it to assume the ACTIVE state.
        /// </summary>
        public const ushort ATTR_MINIMUMONTIME = 0x0043;
        ...
        /// <summary>
        /// The RelinquishDefault attribute, of type Boolean is  the  default  value  to  be
        /// used  for  the PresentValue attribute  when all  elements of  the PriorityArray  
        /// attribute are marked as invalid.
        /// </summary>
        ...
        protected override Dictionary<ushort, ZclAttribute> InitializeServerAttributes()
        {
            ...
            attributeMap.Add(ATTR_MINIMUMOFFTIME, new ZclAttribute(this, ATTR_MINIMUMOFFTIME, "Minimum Off Time", ZclDataType.Get(DataType.UNSIGNED_32_BIT_INTEGER), false, true, true, false));
            attributeMap.Add(ATTR_MINIMUMONTIME, new ZclAttribute(this, ATTR_MINIMUMONTIME, "Minimum On Time", ZclDataType.Get(DataType.UNSIGNED_32_BIT_INTEGER), false, true, true, false));
            ...
            attributeMap.Add(ATTR_RELINQUISHDEFAULT, new ZclAttribute(this, ATTR_RELINQUISHDEFAULT, "Relinquish Default", ZclDataType.Get(DataType.ENUMERATION_8_BIT), false, true, false, false));
